...
public class TextGlow1 : BaseMeshEffect
{
    ...
    private static readonly List<UIVertex> m_VetexList = new List<UIVertex>();
        ...
        Vector4 pUVOrigin)
    {
        ...
        // UV
        Vector2 uv = new Vector2(pVertex.uv0.x, pVertex.uv0.y);
