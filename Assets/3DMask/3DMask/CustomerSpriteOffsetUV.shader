...
Shader "Customer/Theme/CrazyDollar/CustomerSpriteOffsetUV" {
    Properties
    {
        ...
        _fUVSpeedX("fUVSpeedX", Float) = 0
        _fUVSpeedY("fUVSpeedY", Float) = 0
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            v2f SpriteVert(appdata_t IN)
            {
                ...
                float2 offsetUV = _Time.x * float2(_fUVSpeedX, _fUVSpeedY);
				float2 uv = IN.texcoord + offsetUV;
                OUT.texcoord = uv;
