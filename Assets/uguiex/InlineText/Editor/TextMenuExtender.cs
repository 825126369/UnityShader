...
public class TextInlineMenuExtender
{
    [MenuItem("GameObject/UI/TextInline", false, 10)]
    static void CreateCustomGameObject(MenuCommand menuCommand)
    {
        GameObject go = null;
        InlineText _inline = AssetDatabase.LoadAssetAtPath<InlineText>("Assets/TextInlineSprite/Prefabs/TextInline.prefab");
        if (_inline)
        {
        ...
        else
        {
            ...
            //line.material = AssetDatabase.LoadAssetAtPath<Material>("Assets/arts/gui/material/UGUIEmoji.mat");
            //InlineManager inlineMgr = go.AddComponent<InlineManager>();
            //inlineMgr.emojiContent = AssetDatabase.LoadAssetAtPath<TextAsset>("Assets/arts/gui/tex_all/emoji_tex/emoji.txt");
        }
        go.name = "InlinText";
