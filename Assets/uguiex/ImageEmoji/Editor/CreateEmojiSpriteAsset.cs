...
namespace EmojiUI
{
    public static class CreateEmojiEmojiSpriteAsset
{
    public const string assetPath = "Assets/arts/gui/tex_px/habi_emoji/emoji.png";

    [MenuItem("Assets/Create/SSSGame/ImageEmoji/Sprite Asset", false,10)]
    static void CreateEmojiSprite()
    {
    ...
    static void GenerateSpriteInfo(string unitypath)
    {
        ...
        if (sourceTex != null)
        {
            ...
            EmojiUI.EmojiSpriteAsset spriteAsset = AssetDatabase.LoadAssetAtPath(filePath, typeof(EmojiUI.EmojiSpriteAsset)) as EmojiUI.EmojiSpriteAsset;
            int tag = 0;
            if (spriteAsset != null)
            {
                tag = spriteAsset.ID;
            ...
            //replace
            spriteAsset = ScriptableObject.CreateInstance<EmojiUI.EmojiSpriteAsset>();
            spriteAsset.ID = tag;
